...
// <i> Time of single measurement can be calculated as T = (1/2)*MEASUREMENT_PERIOD*(1/f_OSC) where f_OSC = I_SOURCE / (2C*(VUP-VDOWN) ).
// I_SOURCE, VUP and VDOWN are values used to initialize COMP and C is capacitance of used pad.
